        ...
        for idx in trange(len(df), desc="Processing images"):
            ...
            if map_api == 'google':
                    ...
                    res_google = requests.get(
                        f'https://maps.googleapis.com/maps/api/staticmap?center={latitude},{longitude}&zoom={zoom}&size=300x300&maptype=satellite&key={GOOGLE_API_KEY}')
                    ...
                    with open(f"{company_name}.png", "wb") as f:
                        ...
                        try:
                            ...
                            print(sub_category)
                            print(company_name + ".png")
                            image.save(
                                f'/Users/nathanieljacques/Rel8ed.to/CTG/prototype/data/reject/{company_name + ".png"}', 'png')
                    counter += 1
